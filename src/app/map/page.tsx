  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="mb-5 flex items-center justify-between">
        <div>
          <p className="text-sm text-cyan-400">MONITORING PASIEN</p>
          <h1 className="text-2xl font-bold text-slate-100">Denah Lokasi Rawat Jalan</h1>
        </div>
        <a href="/dashboard" className="rounded-lg border border-slate-700 px-4 py-2 text-sm text-slate-300 hover:bg-slate-800">Dashboard Antrian</a>
      </div>
